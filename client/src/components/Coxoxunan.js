  ...
  return (
    < div id='bestreading' style={{ marginLeft: '38px',marginRight: '38px'}}>
        ...
        <Routes>
            <Route path='/' element={
            <>
            <BookCard id='1' author='Dan Brown' bookname='Code Da Vinci' image={book1} aboutbook='While in Paris on business, Harvard symbologist Robert Langdon receives an urgent late-night phone call: the elderly curator of the Louvre has been murdered inside the museum. Near the body, police have found a baffling cipher. '/>
            <BookCard id='2' author='Agatha Christie' bookname='And Then There Were None' image={book2} aboutbook='Ten Little Niggers, later re-titled And Then There Were None, and also titled Ten Little Indians, is considered author Agatha Christies best and most ambitious work. The mystery novel has been adapted for both theatre' />
            ...
            <BookCard id='5' author='Çingiz Abdullayev' bookname='Vicdan' image={book5} aboutbook='"İstəyirdim ki, onlar ölməmişdən əvvəl əzab çəksinlər. Hər şeyi bilsinlər və hiss etsinlər. Bilirəm ki, indi səsimi yazırlar, sonra hamısından mənə qarşı istifadə edəcəklər, amma cəhənnəm olsun, qoy yazsınlar... '/>
            </>}>
